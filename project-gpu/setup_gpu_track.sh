...
PDF_OCR_FAST_LANG=korean
PDF_OCR_FAST_DEVICE=gpu:0
PDF_OCR_FAST_VL_FALLBACK=0
PDF_OCR_FAST_ENABLE_HPI=0
PDF_OCR_FAST_USE_DOC_ORIENTATION=0
PDF_OCR_FAST_USE_DOC_UNWARPING=0
PDF_OCR_FAST_USE_TEXTLINE_ORIENTATION=0
...
EMBEDDING_QWEN_QUERY_INSTRUCTION="Given a user question, retrieve relevant passages that answer the question"
EMBEDDING_MODEL_DEVICE=cuda
EMBED_MODEL_DTYPE=bf16
EMBED_BATCH_SIZE=16
EMBED_MIN_BATCH_SIZE=4
EMBED_MAX_QUERY_TOKENS=384
EMBED_MAX_PASSAGE_TOKENS=768
EMBED_MAX_BATCH_TOKENS=8192
EMBED_LENGTH_BUCKETING=1
EMBED_NORMALIZE=1
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
...
RAG_ROLE_ROUTING_STRICT=0
RAG_TRACE_TOP_N=8
UPLOAD_JOB_RETENTION_SECONDS=86400
UPLOAD_JOB_RETENTION_MAX_ROWS=5000
UPLOAD_JOB_PRUNE_INTERVAL_SECONDS=3600
UPLOAD_JOB_PRUNE_BATCH_SIZE=1000
AUTH_SESSION_PRUNE_LIMIT=1000
RAG_LOG_RETENTION_DAYS=30
RAG_LOG_RETENTION_MAX_ROWS=50000
RAG_LOG_PRUNE_INTERVAL_SECONDS=3600
RAG_LOG_PRUNE_BATCH_SIZE=2000
COMPASS_RUNTIME_LOG_RETENTION_DAYS=14
COMPASS_RUNTIME_LOG_MAX_DIRS=30
OPERATIONAL_JSONL_MAX_BYTES=20971520
OPERATIONAL_JSONL_BACKUP_COUNT=5
...
TXT_CHUNK_MIN_TOKENS=420
TXT_CHUNK_MAX_TOKENS=900
TXT_CHUNK_TARGET_TOKENS_REAL=480
TXT_CHUNK_MAX_TOKENS_REAL=640
TXT_CHUNK_OVERLAP_RATIO=0.25
PDF_CHUNK_TARGET_TOKENS=640
PDF_CHUNK_MIN_TOKENS=420
PDF_CHUNK_MAX_TOKENS=900
PDF_CHUNK_TARGET_TOKENS_REAL=480
PDF_CHUNK_MAX_TOKENS_REAL=640
...
HWPX_CHUNK_TARGET_TOKENS_REAL=220
HWPX_CHUNK_MAX_TOKENS_REAL=320
